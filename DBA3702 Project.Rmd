...
```{r}
#clinics_clean[clinics_clean$HCI_NAME == "NEWLIFE FAMILY CLINIC & SURGERY",]
with(clinics_clean[clinics_clean$HCI_NAME == "NEWLIFE FAMILY CLINIC & SURGERY",],  
 geocode(location = paste(BLK_HSE_NO, STREET_NAME, ", Singapore,", POSTAL_CD), output = "latlon", source = "google"))
```
